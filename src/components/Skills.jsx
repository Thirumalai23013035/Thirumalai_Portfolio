...
const Skills = () => {
  ...
  return (
    <section id="skills" className="bg-[#0d0d0d] text-white py-28 px-6 md:px-12 w-full relative overflow-hidden font-sans border-t border-white/10">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {displayedSkills.map((skill, index) => (
            <div
              ...
              className="group relative bg-[#141414] border border-white/10 hover:border-[#ff2a2a]/50 rounded-2xl p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(255,42,42,0.15)] flex flex-col justify-between"
            >
              <div>
        ...
        <div className="mt-16 bg-gradient-to-r from-red-950/30 via-[#181818] to-red-950/30 border border-red-500/20 rounded-3xl p-8 text-center" data-aos="fade-up">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {['Java Full Stack', 'MERN Stack', 'Object-Oriented Programming (OOP)', 'Data Structures & Algorithms', 'RESTful Microservices', 'MVC Architecture', 'DBMS & Relational Modeling', 'Version Control (Git/GitHub)'].map((concept, i) => (
              <span key={i} className="px-4 py-2 rounded-xl bg-white/5 border border-white/10 text-xs md:text-sm font-semibold text-gray-200">
                ⚡ {concept}
              </span>
            ))}
          </div>
